# Copied from Python 3.6 github repo at
# https://raw.githubusercontent.com/python/cpython/master/Lib/test/test_textwrap.py

# With only a few changes (mainly noting Unicode-containing
# strings with a u'' prefix) for Python 2 cross-compatibility.
...
from textwrap3 import TextWrapper, wrap, fill, dedent, indent, shorten
...
"""
    ...
    def test_no_split_at_umlaut(self):
        ...
        self.check_wrap(text, 13, ["Die", u"Empf\xe4nger-", "Auswahl"])
    ...
    def test_non_breaking_space(self):
        text = u'This is a sentence with non-breaking\N{NO-BREAK SPACE}space.'

        self.check_wrap(text, 20,
                        ['This is a sentence',
                         'with non-',
                         u'breaking\N{NO-BREAK SPACE}space.'],
                        break_on_hyphens=True)

        self.check_wrap(text, 20,
                        ['This is a sentence',
                         'with',
                         u'non-breaking\N{NO-BREAK SPACE}space.'],
                        break_on_hyphens=False)

    def test_narrow_non_breaking_space(self):
        text = ('This is a sentence with non-breaking'
                u'\N{NARROW NO-BREAK SPACE}space.')

        self.check_wrap(text, 20,
                        ['This is a sentence',
                         'with non-',
                         u'breaking\N{NARROW NO-BREAK SPACE}space.'],
                        break_on_hyphens=True)

        self.check_wrap(text, 20,
                        ['This is a sentence',
                         'with',
                         u'non-breaking\N{NARROW NO-BREAK SPACE}space.'],
                        break_on_hyphens=False)
